...
+ (id)shareInstance {
    static TJAudioPlayerManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[TJAudioPlayerManager alloc] init];
    });
    return instance;
}
...
- (void)setDelegate:(id<TJAudioPlayerManagerDelegate>)delegate {
